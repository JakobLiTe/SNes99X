...
rOP8 (AEX1,     Absolute,                         WRAP_NONE, LDX)
rOP16(AEX0,     Absolute,                         WRAP_NONE, LDX)
rOPX (AESlow,   AbsoluteSlow,                     WRAP_NONE, LDX)

rOP8 (BEX1,     AbsoluteIndexedYX1,               WRAP_NONE, LDX)
rOP16(BEX0,     AbsoluteIndexedYX0,               WRAP_NONE, LDX)
rOPX (BESlow,   AbsoluteIndexedYSlow,             WRAP_NONE, LDX)
...
rOP8 (ACX1,     Absolute,                         WRAP_NONE, LDY)
rOP16(ACX0,     Absolute,                         WRAP_NONE, LDY)
rOPX (ACSlow,   AbsoluteSlow,                     WRAP_NONE, LDY)

rOP8 (BCX1,     AbsoluteIndexedXX1,               WRAP_NONE, LDY)
rOP16(BCX0,     AbsoluteIndexedXX0,               WRAP_NONE, LDY)
rOPX (BCSlow,   AbsoluteIndexedXSlow,             WRAP_NONE, LDY)
...
wOP8 (8EX1,     Absolute,                         WRAP_NONE, STX)
wOP16(8EX0,     Absolute,                         WRAP_NONE, STX)
wOPX (8ESlow,   AbsoluteSlow,                     WRAP_NONE, STX)
...
wOP8 (8CX1,     Absolute,                         WRAP_NONE, STY)
wOP16(8CX0,     Absolute,                         WRAP_NONE, STY)
wOPX (8CSlow,   AbsoluteSlow,                     WRAP_NONE, STY)
...
mOP8 (1CM1,     Absolute,                         WRAP_NONE, TRB)
mOP16(1CM0,     Absolute,                         WRAP_NONE, TRB)
mOPM (1CSlow,   AbsoluteSlow,                     WRAP_NONE, TRB)
...
mOP8 (0CM1,     Absolute,                         WRAP_NONE, TSB)
mOP16(0CM0,     Absolute,                         WRAP_NONE, TSB)
mOPM (0CSlow,   AbsoluteSlow,                     WRAP_NONE, TSB)
